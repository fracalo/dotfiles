...
if has("spell")
    call s:HL('SpellCap', 'dalespale', 'bg', 'underline', 'bold', 'dalespale')

    call s:HL('SpellBad', '', 'bg', 'underline', 'dalespale')
    call s:HL('SpellLocal', '', '', 'underline', 'dalespale')
    call s:HL('SpellRare', '', '', 'underline', 'dalespale')
endif
